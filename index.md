...
`   scores = cross_val_score(my_model, X, y, scoring='neg_mean_squared_error', cv=5) scores   `The concepts of Multivariate Regression and Gradient Boosting description: It descripes the analysis and gives intution for Multivariate Regression and Gradient Boosting
=========================================================================================================================================================================
...
`   scores = cross_val_score(my_model, X, y, scoring='neg_mean_squared_error', cv=5) score
